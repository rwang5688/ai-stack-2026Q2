#!/usr/bin/env python3
"""
# Meta Tooling Example (Windows Compatible)
...
NOTE: This is a Windows-compatible version that removes the shell tool import which causes
ModuleNotFoundError on Windows due to Unix-only dependencies (termios, pty, tty).
"""
...
from strands_tools import editor, load_tool  # Removed shell import for Windows compatibility
...
NOTE: Shell commands are not available in this Windows-compatible version. Use the editor tool for all file operations.
...
agent = Agent(
    ...
    tools=[load_tool, editor]  # Removed shell tool for Windows compatibility
)


# Example usage
if __name__ == "__main__":
    print("\nMeta-Tooling Demonstration (Windows Compatible)")
    print("===============================================")
    print("Commands:")
    ...
    print("\nNOTE: This Windows-compatible version removes shell tool functionality")
    print("      but retains full meta-tooling capabilities for tool creation.")
