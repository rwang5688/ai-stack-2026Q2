...
1. **Windows Users:** Use Git Bash terminal for consistent Linux-like commands
2. **Install Git for Windows** with Git Bash option enabled
3. **Use forward slashes** in paths when possible
4. **Use the Windows-compatible MCP examples** when provided

### Command Equivalents

| Task | Linux/macOS | Git Bash (Windows) | Windows CMD |
|------|-------------|-------------------|-------------|
| Run Python script | `python script.py` | `python script.py` | `python script.py` |
