...
class CdkStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # Build Dockerfile from docker_app/ directory
        # Path is relative to where CDK runs (workshop4/phase2/)
        ...
        # Grant access to read the Cognito secret in Secrets Manager
        ...
        # Default action denies requests without the custom header
