...
from config import get_sagemaker_model_endpoint, get_sagemaker_inference_component, get_aws_region
...
def create_sagemaker_model(
    ...
    Args:
        ...
        inference_component: Inference component name (for multi-model endpoints).
                           If None, uses value from get_sagemaker_inference_component().
    ...
    if not endpoint_name or endpoint_name == "my-llm-endpoint":
        raise ValueError(
            "SageMaker endpoint name is required. "
            "Set SAGEMAKER_MODEL_ENDPOINT environment variable or pass endpoint_name parameter."
        )
