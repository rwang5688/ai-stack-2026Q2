...
echo "  pip list                    # List all installed packages"
echo "  pip list | grep strands     # Show only strands packages"
echo "  pip show strands-agents     # Show details about strands-agents"
